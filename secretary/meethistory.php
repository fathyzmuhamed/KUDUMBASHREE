...
<script type="text/javascript">
	...
	document.getElementById('meet2').setAttribute('class','active');
</script>
												...
												while($row=mysqli_fetch_array($res)) {
													...
													<tr>
														...
														<td style="text-align: center;">
															...
															if($row['attstatus']==0) {
																?>
																<button type="button" onclick="document.attfrm.meetid.value=<?php echo $row['meetid']?>" data-toggle="modal" data-target="#myModal" class="btn btn-sm btn-primary" style="margin: auto;display: block;">Add</button>
																<?php
															}
															else {
																?>
														...
														<td style="text-align: center;">
															...
															if($row['thriftstatus']==0) {
																?>
																<button type="button" onclick="document.thriftfrm.meetid.value=<?php echo $row['meetid']?>" data-toggle="modal" data-target="#myModal1" class="btn btn-sm btn-primary" style="margin: auto;display: block;">Add</button>
																<?php
															}
															else {
																?>
														...
														<td style="text-align: center;">
															...
															if($row['minutes']=='') {
																?>
																<button type="button" onclick="document.minutesfrm.meetid.value=<?php echo $row['meetid']?>" data-toggle="modal" data-target="#myModal2" class="btn btn-sm btn-primary" style="margin: auto;display: block;">Add</button>
																<?php
															}
															else {
																?>
...
<div class="modal fade" id="myModal2">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<form class="form-material" name="minutesfrm" method="post" action="php/addatt.php" enctype="multipart/form-data">
				<!-- Modal body -->
				<div class="modal-body">
					<div class="form-group form-default form-static-label">
						<input type="file" name="minutes" class="form-control" required="" accept="application/pdf">
