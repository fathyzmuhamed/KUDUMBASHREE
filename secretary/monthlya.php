					...
					<div class="col-md-6">
						<div class="card">
							<div class="card-header">
								<h5>Issue New Monthly Collection</h5>
							</div>
							<div class="card-block">
								<form class="form-material" name="newfrm" id="newfrm" method="post" action="php/alltransactions.php">
									<div class="form-group form-default form-static-label">
										<input type="date" name="date" class="form-control" onkeydown="return false">
										...
										<tbody>
											...
											while($row=mysqli_fetch_array($res)) {
												...
												<tr>
													...
													<td>
														<button type="button" onclick="updatem('<?php echo $row['mcid']?>')" class="btn btn-sm btn-primary" style="margin: auto;display: block;">Update</button>
													</td>
												</tr>
												<?php
											}
