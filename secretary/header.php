...
<head>
    <title>Kudumbashree - Secretary</title>
                    ...
                    <div class="pcoded-wrapper">
                        <nav class="pcoded-navbar">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu " id='meet'>
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" " id="meet1">
                                            <a href="addmeet.php" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Add Meeting</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="meet2">
                                            <a href="meethistory.php" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Meeting History</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="pcoded-hasmenu " id='atrn'>
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" " id="atrn0">
                                            <a href="updatecol.php" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Update Collections</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="atrn1">
                                ...
                                <li class="" id="glry">
                                    <a href="gallery.php" class="waves-effect waves-dark">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Welcome Back! Secretary</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
