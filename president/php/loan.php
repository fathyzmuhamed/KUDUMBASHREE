...
if (isset($_POST['approve'])) {
	...
	$sql="update loan set lstatus=1,approveddate='$today',expclosedate='$date' where loanid=$_POST[lid]";echo $sql;
	$ob->db_write($sql);
	echo 1;
	exit();
}
if (isset($_POST['reject'])) {
	$sql="update loan set lstatus=-1,reason='$_POST[reply]' where loanid=$_POST[lid]";
	$ob->db_write($sql);
	echo 1;
	exit();
}
