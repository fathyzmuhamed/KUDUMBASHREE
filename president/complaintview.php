...
<script type="text/javascript">
	...
	document.getElementById('comp3').setAttribute('class','active');
</script>
<!-- Page-header end -->
				...
				<div class="card">
					...
					<div class="card-block table-border-style">
						<div class="table-responsive">
							<?php
							$sql="select complaints.status as cstatus,complaints.*,reg.* from complaints,reg where reg.username=complaints.username order by complaints.status";
							$res=$ob->db_read($sql);
							?>
											...
											<td>
												<div class="btn-group" role="group" style="display: inline-flex;">
													...
													if($row['cstatus']==0) 
													{
														...
														<button type="button" onclick="frwd('<?php echo $row['compid']?>')" class="btn btn-sm btn-success">Forward to ADS</button>
														<?php
													}
													?>
